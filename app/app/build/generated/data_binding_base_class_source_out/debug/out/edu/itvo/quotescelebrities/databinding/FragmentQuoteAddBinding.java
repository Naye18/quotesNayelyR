...
public final class FragmentQuoteAddBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentQuoteAddBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSave,
  ...
  @NonNull
  public static FragmentQuoteAddBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentQuoteAddBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_quote_add, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentQuoteAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentQuoteAddBinding((ConstraintLayout) rootView, btnSave, etAuthor, etId,
