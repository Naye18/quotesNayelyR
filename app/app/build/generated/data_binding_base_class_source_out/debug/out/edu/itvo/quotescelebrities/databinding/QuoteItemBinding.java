...
public final class QuoteItemBinding implements ViewBinding {
  ...
  private QuoteItemBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cvQuote,
      @NonNull ImageView imgDelete, @NonNull ImageView imgEdit, @NonNull TextView tvAuthor,
      @NonNull TextView tvQuote) {
    this.rootView = rootView;
    this.cvQuote = cvQuote;
  ...
  public static QuoteItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cvQuote;
      CardView cvQuote = ViewBindings.findChildViewById(rootView, id);
      if (cvQuote == null) {
        break missingId;
      }
      ...
      return new QuoteItemBinding((ConstraintLayout) rootView, cvQuote, imgDelete, imgEdit,
          tvAuthor, tvQuote);
    }
