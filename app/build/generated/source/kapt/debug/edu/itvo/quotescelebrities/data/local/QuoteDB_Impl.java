...
import edu.itvo.quotescelebrities.data.local.daos.QuoteDao_Impl;
...
public final class QuoteDB_Impl extends QuoteDB {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `quote` (`id` INTEGER NOT NULL, `quote` TEXT NOT NULL, `author` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ab597459d93823e8a9812200d9731c2a')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsQuote = new HashMap<String, TableInfo.Column>(3);
        ...
        if (! _infoQuote.equals(_existingQuote)) {
          return new RoomOpenHelper.ValidationResult(false, "quote(edu.itvo.quotescelebrities.data.local.entities.QuoteEntity).\n"
                  + " Expected:\n" + _infoQuote + "\n"
                  + " Found:\n" + _existingQuote);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "ab597459d93823e8a9812200d9731c2a", "bf4fc0e7e4422322ee518f4ddc3f6b17");
