 ...
 */
public abstract class Hilt_QuoteAddFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuoteAddFragment() {
    super();
  }

  Hilt_QuoteAddFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuoteAddFragment_GeneratedInjector) this.generatedComponent()).injectQuoteAddFragment(UnsafeCasts.<QuoteAddFragment>unsafeCast(this));
    }
  }
