 ...
 */
public abstract class Hilt_QuoteEditFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuoteEditFragment() {
    super();
  }

  Hilt_QuoteEditFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuoteEditFragment_GeneratedInjector) this.generatedComponent()).injectQuoteEditFragment(UnsafeCasts.<QuoteEditFragment>unsafeCast(this));
    }
  }
