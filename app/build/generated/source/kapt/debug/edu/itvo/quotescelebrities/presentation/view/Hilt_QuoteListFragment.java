 ...
 */
public abstract class Hilt_QuoteListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuoteListFragment() {
    super();
  }

  Hilt_QuoteListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuoteListFragment_GeneratedInjector) this.generatedComponent()).injectQuoteListFragment(UnsafeCasts.<QuoteListFragment>unsafeCast(this));
    }
  }
