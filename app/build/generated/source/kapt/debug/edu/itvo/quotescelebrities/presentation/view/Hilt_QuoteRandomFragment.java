 ...
 */
public abstract class Hilt_QuoteRandomFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuoteRandomFragment() {
    super();
  }

  Hilt_QuoteRandomFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuoteRandomFragment_GeneratedInjector) this.generatedComponent()).injectQuoteRandomFragment(UnsafeCasts.<QuoteRandomFragment>unsafeCast(this));
    }
  }
